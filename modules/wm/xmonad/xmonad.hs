...
myKeyBindings =
	...
	-- , ((mod4Mask, xK_minus), spawn "smart-playerctl next")
    , ((mod4Mask, xK_minus), withFocused $ whenStickyWithFallback $ (changeStickySize (-1), spawn "smart-playerctl next"))
    , ((mod4Mask, xK_period), spawn "smart-playerctl play-pause")
    , ((mod4Mask, xK_comma), spawn "smart-playerctl previous")
    ]

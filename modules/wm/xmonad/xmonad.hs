...
myKeyBindings =
    ...
    , ((mod4Mask, xK_d), spawn "xmonad-duplicate-alacritty")
    ...
    -- , ((0, xF86XK_MonBrightnessUp), spawn "~/.local/bin/set-brightness +")
    -- , ((0, xF86XK_MonBrightnessDown), spawn "~/.local/bin/set-brightness -")
    , ((0, xF86XK_MonBrightnessUp), spawn "xmonad-set-brightness +")
    , ((0, xF86XK_MonBrightnessDown), spawn "xmonad-set-brightness -")
